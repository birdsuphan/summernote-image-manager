...
(function (factory) {
  ...
  $.extend($.summernote.lang, {
    'en-US': {
      ...
      image: {
        image: 'Picture',
        insert: 'Summernote Image Manager',
  ...
  var ImageDialog = function (context) {
    ...
    this.showImageDialog = function () {
      return $.Deferred(function (deferred) {
        ...
        ui.onDialogShown(self.$dialog, function () {
          context.triggerEvent('dialog.shown');
          var newhtml = '<div class="col-xs-12" style="text-align:center;"><img src="'+summernoteUrl+'/summernote/319.gif"/></div>';
          ...
          $.ajax({ 
			   type: "GET", 
			   url:  summernoteUrl+"/imagemanager/filemanager.php",
